        ...
        switch (reply.cmd) {
            ...
            case commands_1.Commands.ENCODER:
                if (reply.answer) {
                    ...
                    posArray = posArray.filter((el) => el !== undefined);
                    posArray = posArray.map((eachAxis) => {
                        ...
                        if (quotePosition !== -1 && equalPosition !== -1) {
                            return new robot_cmd_1.RobotAxis(eachAxis.substring(quotePosition + 1, equalPosition).trim(), parseInt(eachAxis.slice(equalPosition + 1)));
                        }
                    });
            ...
            case commands_1.Commands.STATUS:
                if (reply.answer) {
                    ...
                    answerArr = answerArr.filter((el) => el !== undefined);
