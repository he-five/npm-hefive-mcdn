        ...
        switch (reply.cmd) {
            ...
            case commands_1.Commands.STATUS:
                if (reply.answer) {
                    ...
                    status.homed = !Boolean(num & robot_cmd_1.RobotStatusMask.Homed);
                    status.busy = Boolean(num & robot_cmd_1.RobotStatusMask.Busy);
                    status.index = Boolean(num & robot_cmd_1.RobotStatusMask.Index);
                    status.limitPos = Boolean(num & robot_cmd_1.RobotStatusMask.LimitPos);
                    ...
                    status.emergencyStop = Boolean(num & robot_cmd_1.RobotStatusMask.EmergencyStop);
                    status.inhibit = Boolean(num & robot_cmd_1.RobotStatusMask.Inhibit);
                    status.encoderErr = Boolean(num & robot_cmd_1.RobotStatusMask.EncoderErr);
                    status.maxError = Boolean(num & robot_cmd_1.RobotStatusMask.MaxError);
