    ...
    onData(data) {
        ...
        if (this.reply.endsWith(mcdn_cmd_1.cmdPass) || this.reply.endsWith(mcdn_cmd_1.cmdFail)) {
            ...
            try {
                ...
                if (driverReply.cmd === mcdn_cmd_1.ServiceCommands.STRING ||
                    driverReply.cmd === mcdn_cmd_1.ServiceCommands.GET_TRACE_DATA ||
                    driverReply.cmd === commands_1.Commands.FW_VER) {
                    this.cmdInProgress = false;
