        ...
        switch (reply.cmd) {
            ...
            case commands_1.Commands.STATUS:
                if (reply.answer) {
                    ...
                    status.positionCaptured = (num & mcdn_cmd_1.StatusMask.PosCaptured) == 0 ? true : false;
                    status.homing = (num & mcdn_cmd_1.StatusMask.IdxCaptured) == 0 ? true : false;
                    status.homingCompleted = (num & mcdn_cmd_1.StatusMask.Homed) == 0 ? true : false;
                    status.phaseAligning = (num & mcdn_cmd_1.StatusMask.Aligning) == 0 ? true : false;
                    status.phaseAlignmentCompleted = (num & mcdn_cmd_1.StatusMask.Aligned) == 0 ? true : false;
                    status.hallSensorScanning = (num & mcdn_cmd_1.StatusMask.Busy) == 0 ? true : false;
                    // OVER CURRENT
                    status.pvtQueueFull = (num & mcdn_cmd_1.StatusMask.Inhibit) == 0 ? true : false;
                    status.pvtQueueEmpty = (num & mcdn_cmd_1.StatusMask.PvtEmpty) == 0 ? true : false;
                    status.overCurrentWarning = (num & mcdn_cmd_1.StatusMask.AmpWarning) == 0 ? true : false;
                    status.amplifierCurrentLimit = (num & mcdn_cmd_1.StatusMask.AmpFault) == 0 ? true : false;
                    status.followingErrorLimit = (num & mcdn_cmd_1.StatusMask.PosError) == 0 ? true : false;
                    status.counterWrapAround = (num & mcdn_cmd_1.StatusMask.Wraparound) == 0 ? true : false;
                    reply.answer = status;
                }
                break;
            case commands_1.Commands.INPUTS:
