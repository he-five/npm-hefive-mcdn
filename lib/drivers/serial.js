...
class Serial {
    ...
    connect(portName) {
        if (!this.connected) {
            ...
            this.queue.enqueue(mcdn_cmd_1.Commands.EMPTY);
    ...
    sendStr(cmd) {
        ...
        if (this.cmdInProgress == false) {
            ...
            this.sendThruPort(mcdn_cmd_1.Commands.STRING, cmd);
        }
        // else{
    ...
    sendThruPort(cmd, data) {
        ...
        switch (this.cmd) {
            case mcdn_cmd_1.Commands.FW_VER:
                actualCmd = 'ver';
                break;
            case mcdn_cmd_1.Commands.ENCODER:
                actualCmd = 'pos';
                break;
            case mcdn_cmd_1.Commands.FOLLOWING_ERROR:
                actualCmd = 'err';
                break;
            case mcdn_cmd_1.Commands.EMPTY:
                actualCmd = ' ';
                break;
            case mcdn_cmd_1.Commands.STRING:
                actualCmd = data;
                break;
        }
