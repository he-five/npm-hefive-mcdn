...
driver.on('connected', (data) => {
    ...
    setInterval(() => {
        ...
        driver.sendCmd(index_1.Commands.AXESNUM, testCallback2);
        driver.sendCmd(index_1.Commands.STATUS, testCallback2);
        driver.sendCmdDataNumber(index_1.CommandsData.RelativeMove, new robot_cmd_1.RobotData('T', 10000), testCallbackAfetrMvr);
