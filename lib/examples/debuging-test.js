...
driver.on('connected', () => {
    ...
    driver.sendCmd(index_1.Commands.FW_VER, testCallback);
    console.time('EXECUTION TIME Commands.ENCODER');
    driver.sendCmd(index_1.Commands.ENCODER, testCallback);
    console.time('EXECUTION TIME Commands.FOLLOWING_ERROR');
    driver.sendCmd(index_1.Commands.FOLLOWING_ERROR, testCallback);
