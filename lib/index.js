...
exports.Status = exports.RelativeMove = exports.CommandReply = exports.McdnDriver = exports.Commands = void 0;
...
(function (Commands) {
    ...
    Commands["RelativeMove"] = "RelativeMove";
...
class McdnDriver extends events_1.EventEmitter {
    ...
    sendCmd(cmd, data = undefined, callback) {
        var _a, _b;
