...
exports.ServiceCommands = exports.Inputs = exports.SerialPortType = exports.SerialPortInfo = exports.Status = exports.CommandReply = exports.McdnDriver = exports.RobotStatus = exports.RobotAxisData = void 0;
...
const robot_cmd_1 = require("./drivers/robot-cmd");
Object.defineProperty(exports, "RobotAxisData", { enumerable: true, get: function () { return robot_cmd_1.RobotAxisData; } });
Object.defineProperty(exports, "RobotStatus", { enumerable: true, get: function () { return robot_cmd_1.RobotStatus; } });
...
class McdnDriver extends events_1.EventEmitter {
    ...
    openMcdnPort(...parameters) {
        this.createProcess(communication_types_1.CommunicationTypes.MCDN, parameters);
    }
    openTcpPort(...parameters) {
        this.createProcess(communication_types_1.CommunicationTypes.TCP, parameters);
    }
    openSerialPort(...parameters) {
        this.createProcess(communication_types_1.CommunicationTypes.SERIAL, parameters);
    }
    createProcess(communication, parameters) {
        var _a, _b, _c;
        ...
        if (this.driverProcess.connected) {
            ...
            this.consumeEvents();
            if (cmdPass)
                (_a = this.driverProcess) === null || _a === void 0 ? void 0 : _a.send(new mcdn_cmd_1.McdnCmd(commands_data_1.CommandsData.CmdPassString, cmdPass));
            if (cmdFail)
                (_b = this.driverProcess) === null || _b === void 0 ? void 0 : _b.send(new mcdn_cmd_1.McdnCmd(commands_data_1.CommandsData.CmdFailString, cmdFail));
            (_c = this.driverProcess) === null || _c === void 0 ? void 0 : _c.send(new mcdn_cmd_1.McdnCmd(mcdn_cmd_1.ServiceCommands.CONNECT, portName));
        }
    }
    disconnect() {
        var _a;
    ...
    setupTrace(traceData, callback) {
        this.sendToDriver(undefined, mcdn_cmd_1.ServiceCommands.CH1, traceData.channel1Type);
        this.sendToDriver(undefined, mcdn_cmd_1.ServiceCommands.CH2, traceData.channel2Type);
        this.sendToDriver(undefined, mcdn_cmd_1.ServiceCommands.CH3, traceData.channel3Type);
        this.sendToDriver(undefined, mcdn_cmd_1.ServiceCommands.TLEVEL, traceData.level);
        this.sendToDriver(undefined, mcdn_cmd_1.ServiceCommands.TRATE, traceData.rateInMicrosecond);
        this.sendToDriver(callback, mcdn_cmd_1.ServiceCommands.TRACE, traceData.trigger);
    }
    stopTrace(callback) {
        this.sendToDriver(callback, mcdn_cmd_1.ServiceCommands.STOP_TRACE, undefined);
    }
    getTraceData(callback) {
        this.sendToDriver(callback, mcdn_cmd_1.ServiceCommands.GET_TRACE_DATA, undefined);
    }
...
var commands_data_2 = require("./commands-data");
Object.defineProperty(exports, "CommandsData", { enumerable: true, get: function () { return commands_data_2.CommandsData; } });
