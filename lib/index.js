...
class McdnDriver extends events_1.EventEmitter {
    ...
    openMcdnPort(portName) {
        this.createProcess(communication_types_1.CommunicationTypes.MCDN, portName);
    }
    openTcpPort(portName) {
        this.createProcess(communication_types_1.CommunicationTypes.TCP, portName);
    }
    openSerialPort(portName) {
        this.createProcess(communication_types_1.CommunicationTypes.SERIAL, portName);
    }
    createProcess(communication, portName) {
        var _a;
    ...
    setReplyEndString(cmdPass, cmdFail) {
        this.sendCmdDataString(commands_data_1.CommandsData.CmdPassString, cmdPass);
        this.sendCmdDataString(commands_data_1.CommandsData.CmdFailString, cmdFail);
    }
    getFwVersion() {
