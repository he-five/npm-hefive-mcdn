...
exports.CommandReply = exports.McdnDriver = exports.Commands = void 0;
...
class McdnDriver extends events_1.EventEmitter {
    ...
    sendCmd(cmd, callback) {
        ...
        if (callback) {
            ...
            (_a = this.driverProcess) === null || _a === void 0 ? void 0 : _a.send(new mcdn_cmd_1.McdnCmd(cmd, undefined, key));
        }
        else {
            (_b = this.driverProcess) === null || _b === void 0 ? void 0 : _b.send(new mcdn_cmd_1.McdnCmd(cmd, undefined));
        }
    }
    sendStr(str) {
        var _a;
